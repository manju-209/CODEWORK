      ...
      <div className="container mx-auto px-8 lg:px-16 relative z-10">
        ...
        <div className="text-center mb-16 py-12">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold text-primary mb-8 leading-tight">
            Hyperflx: The <span className="bg-gradient-to-r from-primary via-primary-400 to-primary bg-clip-text text-transparent">Smarter Way</span> to Search for Academic Knowledge
          </h1>
